...
int main(int, char**)
{
    ...
    // HWND hwnd = CreateWindowEx(WS_EX_TOPMOST | WS_EX_LAYERED, _T("ImGui Example"), NULL, WS_POPUP, 0, 0, 500, 200, NULL, NULL, wc.hInstance, NULL);
    ...
    while (!done)
    {
        ...
        */
...

        {
            ...
            ImGui::Begin("Edenther (Chat Box)", &show_demo_window, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoBackground);
            ...
            if (ImGui::Button("Quit", ImVec2(128, 19))) show_demo_window = false;
